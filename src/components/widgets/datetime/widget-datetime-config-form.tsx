            ...
            <Tabs defaultValue="general">
              ...
              <TabsContent value="format" className="space-y-6 py-4">
                ...
                {(watchDisplay === "both" || watchDisplay === "timeOnly") && (
                  <Card>
                    <CardContent className="pt-6 space-y-4">
                      <h4 className="text-lg font-semibold">Time Format</h4>
                      <FormField
                        control={form.control}
                        name="timeFormat"
                        render={({ field }) => (
                ...
                {(watchDisplay === "both" || watchDisplay === "dateOnly") && (
                  <Card>
                    <CardContent className="pt-6 space-y-4">
                      <h4 className="text-lg font-semibold">Date Format</h4>
                      <FormField
                        control={form.control}
                        name="dateFormat"
                        render={({ field }) => (
              ...
              <TabsContent value="style" className="space-y-6 py-4">
                <Card>
                  <CardContent className="pt-6 space-y-4">
                    <h4 className="text-lg font-semibold">Text Styling</h4>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="text-3xl font-bold"
                              {...field}
                            />
                          </FormControl>
                          <FormDescription>
