...
import { WeatherDataCurrent } from "@/hooks/use-weather-query";
...
const WidgetWeatherCurrent = ({
  ...
  const renderWeatherCard = (
    ...
    <div className="flex flex-col items-center justify-center w-28 p-3 bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
  ...
  return (
    <div className="flex flex-wrap gap-x-16 items-center justify-center ">
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-800 dark:text-gray-200  mt-4">
        ...
        {renderWeatherCard(
          "Dew Point",
          currentWeather.dewPoint.toFixed(0),
          "°C"
        )}
        {renderWeatherCard(
          "Wind",
